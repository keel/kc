<template>
  <div>
    ...
    <CurdOne v-show="(showContent === 'one')" ref="curdOne" :tbName="tbName" :tbTxt="tbTxt" @setOneParas="setOneParas" @showList="showListNow"><el-button v-if="oneParas.authMap" type="danger" @click="$router.push('/permission/'+oneId)">权限配置</el-button></CurdOne>
...
export default {
  ...
  'methods': {
    ...
    doSearch() {
      ...
      this.$refs.curdList.searchList(this.mkSearchObj(), () => { this.searchLoading = false; });
    },

...
var init = function(configFile) {
  ...
  rootKey = (new Buffer(ktool.md5(kconfig.getConfig().project + kconfig.getConfig().ver+'sessionauthbythistimegood12349876'))).slice(0,16);
...
var sessionSet = function(resp, sid, value, cookieExpireTime, callback) {
  cache.set(sessionPre + sid, value, cookieExpireTime, function(err) {
    if (err) {

 ...
 * @return {}
 */
const sessionSet = function sessionSet(req, resp, key, value, callback = ktool.defaultCallback(null, __filename)) {
 ...
 * @return {}
 */
const sessionGet = function sessionSet(req, resp, key, callback) {
...
const sessionCheck = function(sid, req, resp, callback) {
  ...
  sessionStore.get(sessionPre + sid, function(err, re) {
    ...
    if (!ignoreIpCheck && sessionArr[3] !== getIp(req)) {

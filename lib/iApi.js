...
const initAct = function(actName, showLevel, reqCheckerMap, respMaker, router, isXssFilter, ignoreReqCheckLog, bodyParser, crossDomain) {
  if (!respMaker) {
  ...
  router.post('/' + actName, bodyParser, function(req, resp, next) {
...
const getRouter = function(iiConfig) {
  ...
  for (const act in actions) {
    ...
    initAct(act, showLevel, validators, resper, router, iiObj.isXssFilter, iiObj.ignoreReqCheckLog, actBodyParser, iiObj.crossDomain);
  }
  return router;
};

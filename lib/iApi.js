...
const initAct = function(actName, showLevel, reqCheckerMap, respMaker, router, isXssFilter, ignoreReqCheckLog, bodyParser) {
  if (!respMaker) {
...
const getRouter = function(iiConfig) {
  ...
  for (const act in actions) {
    ...
    initAct(act, showLevel, validators, resper, router, iiObj.isXssFilter, iiObj.ignoreReqCheckLog, actBodyParser);
  }
  return router;
};

...
const synFileSync = function(srcFile, destFile, fn) {
  try {
...
const doSync = function(dir, projectName, port) {
  ...
  synFileSync(path.join(__dirname, '../web/public/js/lyapp.src.js'), path.join(dir, 'web/public/js/lyapp.src.js'), replaceProjectAndPort);
};
